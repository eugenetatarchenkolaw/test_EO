...
Этот GitHub — справочник участника. **Условия и оценку определяют выданные организатором «Постановка_кейса_3.docx» и «Критерии_кейса_3.docx».** При расхождении приоритет имеют эти документы. Материалы здесь помогают найти источники, разобраться в форматах и подготовиться к самостоятельной работе; дополнительных требований и баллов они не вводят.

Решение команды и веса моделей публикуются **в GitVerse**, как указано в постановке. Этот репозиторий на GitHub содержит только дополнительные материалы кейса.
