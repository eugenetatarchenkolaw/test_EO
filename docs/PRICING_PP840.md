...
$$
Р_{opt}=\min\{1,\max[0{,}2;\;-0{,}058\ln(S/r^2)+1{,}037]\}.   P_{opt} = \min\bigl(1;\ \max\bigl(0{,}2;\ -0{,}058\,\ln(S/r^{2}) + 1{,}037\bigr)\bigr)
$$

Для радиолокационных материалов:

$$
Р_{SAR}=\min\{1,\max[0{,}7;\;-0{,}020\ln(S/r^2)+1{,}031]\}.   P_{SAR} = \min\bigl(1;\ \max\bigl(0{,}7;\ -0{,}020\,\ln(S/r^{2}) + 1{,}031\bigr)\bigr)
$$
